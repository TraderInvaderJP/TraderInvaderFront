    ...
    return (
      <div className={'centered'}>
        ...
        <List>
          ...
          <ListItem style={{justifyContent: 'center'}}><NavLink to='/Verification'><Button onClick={this.handleSubmit} variant='outlined'>Confirm</Button>&nbsp;&nbsp;</NavLink>
            <NavLink to='/'><Button onClick={this.cleanInput} variant='outlined'>Cancel</Button></NavLink></ListItem>
        </List>
      </div>
    )
  }
